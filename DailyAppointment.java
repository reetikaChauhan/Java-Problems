...
public class DailyAppointment extends Appointment {
    ...
    public boolean occursOn(int year, int month, int day) {
        ...
        // Override occursOn. Checks the given date parameters year, month, day to see
        // if it is a later
        // date than the appointment date stored in this object. Return true if so,
        // false otherwise

        int tyear = super.getYear();
        int tday = super.getDay();
        int tmonth = super.getMonth();
        if ((year == tyear) && (day > tday) && (month == tmonth)) {
            return true;
        } else if ((year == tyear) && (day == tday) && (month > tmonth)) {
            return true;
        } else if (year > tyear) {
            return true;
        } else {
