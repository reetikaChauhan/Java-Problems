/**
 * A cash register totals up sales of several items purchased by a customer,
 * totals up the payment made,
 * and computes change due.
 * In this class, you should complete the following tasks:
 * 
 * - Implement "recordPurchase" which adds the given item price to the current
 * total
 * - Implement "enterPayment" which takes in a given number of Coin objects, and
 * updates the current
 * total paymennt made.
 * - Implement "giveChange" which calculates the amount of change to be returned
 * after payment
 * 
...
public class CashRegister {
    ...
    public void recordPurchase(double itemPrice) {
        ...
        this.totalOfItemsPurchased = itemPrice + this.totalOfItemsPurchased;
    ...
    public void enterPayment(int coinCount, Coin coinType) {
        ...
        // add to the payment variable the number of coins * the value of the given
        // coins
        // Hint: see class Coin
        this.payment = this.payment + coinCount * coinType.getValue();
    ...
    public double giveChange() {
        ...
        // compute the change to return to the customer , then reset payment and
        // totalOfItemsPurchased to 0 then return the change
        double change = this.payment - this.totalOfItemsPurchased;
