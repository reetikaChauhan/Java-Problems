...
public class FindMaximum {
	public static void main(String[] args) {
		...
		// Assume you do not know how many values there will be, so use the
		// hasNextDouble() method in the loop condition
		// Inside the loop body, read the next double number (NOTE: never call
		// in.nextDouble()
		// more than once inside the loop so use a temporary variable to compare the
		// current number to max)
		// If this current number is greater than max then update max to this current
		// number
