...
public class IsLeapYear {
	...
	// Write a static method isLeapYear. This method returns a boolean (true or
	// false). It takes one parameter: an integer value - the year
...
// A year is a leap year if it is exactly divisible by 400 (i.e. the remainder
// is 0)
// If it is not divisible by 400 then a year is also a leap year if it is
// exactly divisible by 4 AND it is NOT exactly divisible by 100
// Hint: use the modulus operator (i.e. remainder operator) % to check if
// exactly divisible
