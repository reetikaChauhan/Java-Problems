...
public class GroceryStore {
    ...
    // Implement a grocery store constructor which takes in a store name, and
    // initial
    ...
    public void addInventory(GroceryItem type, int amount) {
        ...
        if (type == GroceryItem.LETTUCE) {
            lettuceInventory = lettuceInventory + amount;
        } else if (type == GroceryItem.TOMATO) {
            tomatoInventory = tomatoInventory + amount;
        } else {
            cucumberInventory = cucumberInventory + amount;
        }
